<template>
  <div>
    ...
    <div class="news">
      <div class="news__tape" :style="scrollableElementStyle" ref="scrollableElement">
        <NewsCarousel
          :qq="q"
          :jj="j"
          :screenWidthGadget="screenWidth"
...
<script>
import NewsHeader from '../NewsBLock/NewsHeader.vue';
...
export default {
  ...
  data() {
    return {
      ...
      q: 0, // значение счётчика, индекс this.newsColumns[q], который по центру экрана
      j: 0, // если (this.screenWidth > 855), то по центру экрана два элемента:
      //  this.newsColumns[q] и this.newsColumns[j]
    };
  },
  ...
  methods: {
    ...
    // количество детей newsContainer
